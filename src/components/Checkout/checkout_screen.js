    ...
    return (
        <div className="checkout-wrapper">
            <div className="checkout-left">
                <div className="checkout-header">
                    ...
                    <Link className="checkout-link" to="/shop">
                        KEEP SHOPPING
                        <img className="checkout-arrow-icon" src={arrow}></img>
                    </Link>
                </div>
                ...
                <div className="checkout-info-wrapper">
                    <div className="checkout-info-title">
                        ...
                        <button className="checkout-btn checkout-info-title-btn">EDIT</button>
                    </div>
                    ...
                    <div className="checkout-btn-continue">
                        <button className="checkout-btn checkout-info-content-btn">CONTINUE</button>
                    </div>
                </div>
                <div className="checkout-info-wrapper">
                    <div className="checkout-info-title">
                ...
                <div className="checkout-info-payment">
                    ...
                    <div className="checkout-group-button">
                        <label class="container">Cash on Delivery (COD)
                        ...
                        <label class="container">Momo E-Wallet
                            <input type="radio" name="radio"/>
                            <span class="checkmark"></span>
                        </label>
                    </div>
            ...
            <div className="checkout-right">
                ...
                <div className="checkout-btn-continue">
                    <Link to="/after-checkout" className="checkout-btn-bigger checkout-info-content-btn">
                        ORDER
                    </Link>
                </div>
            </div>
